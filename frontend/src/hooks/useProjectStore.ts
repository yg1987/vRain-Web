...
export const DEFAULT_BOOK_CONFIG: BookConfig = {
  ...
  fonts: [
    ...
    { name: "FangSong", filename: "simfang.ttf", textPointSize: 60, commentPointSize: 30, rotate: 0 },
    { name: "汉明A", filename: "HanaMinA.ttf", textPointSize: 50, commentPointSize: 25, rotate: 0 },
    { name: "汉明B", filename: "HanaMinB.ttf", textPointSize: 50, commentPointSize: 25, rotate: 0 },
  ],
  ...
  decorativeMarks: {
    ...
    circleNote: { enabled: true, offset: { x: 0.55, y: 0.3 }, radius: 0.15, width: 6, color: "#874434" },
    pointNote: { enabled: true, offset: { x: 1.0, y: 0 }, size: 1.2, color: "#874434" },
    lineNote: { enabled: true, offset: { x: 0.5, y: 0 }, width: 7, color: "#874434" },
  },
